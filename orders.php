        ...
        <?php
          ...
          if($result) {
            while($obj = $result->fetch_object()) {
              ...
              // echo "<a href='canel.php?id=$obj->id'>C</a>";
              echo '<div class="small-12">';
              echo '<p><a style="clear:both;" class="button" href="cancel.php?id='.$obj->id.'&code='.$obj->product_code.'&qty='.$obj->units.'">Cancel this Order</a></p></center>';
              echo '</div>';
              echo '<p><hr></p>';
